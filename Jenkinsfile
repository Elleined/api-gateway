pipeline {
    ...
    stages {
        stage("Clone API Gateway from Github") {
            steps {
                echo "Cloning API Gateway from Github. Please Wait..."
                git branch: 'main',
                    url: 'https://github.com/Elleined/api-gateway'
                echo "Cloning API Gateway from Github. Success!"
            }
        }
        ...
        stage("Push docker image to DockerHub") {
            steps {
                ...
                sh 'docker tag api-gateway:latest elleined/api-gateway:latest'
                sh 'docker push elleined/api-gateway:latest'
